...
const DISCUSSION_EMBED = makeEmbed({
    ...
    description: makeLines([
        ...
        '- To keep our community focussed on the primary purpose of this server (Flight Simulation), political discussions are not permitted and will be shut down by Moderators',
        '- Moderators have the full discretion to end, or prevent, any discussions around religion, politics and other sensitive subjects',
