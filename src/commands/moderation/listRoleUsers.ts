...
import { constantsConfig, Logger, makeEmbed, createPaginatedEmbedInteraction, slashCommand, slashCommandStructure } from '../../lib';
...
export default slashCommand(data, async ({ interaction }) => {
    ...
    try {
        return createPaginatedEmbedInteraction(interaction, embeds);
    } catch (error) {
