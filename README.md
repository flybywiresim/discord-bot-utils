...
This is the repository for the FlyByWire Simulations Discord Bot. You can find the repository for the FlyByWire Simulations Sticky Bot [here](https://github.com/flybywiresim/discord-bot-sticky).
